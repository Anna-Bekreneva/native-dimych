...
import {demolishHousesOnTheStreet, getBuildingsWithStaffCounteGreaterThen} from './04_2';
...
test("buildings with correct staff count", () => {
	let buildings = getBuildingsWithStaffCounteGreaterThen(city.governmentBuildings, 500)
